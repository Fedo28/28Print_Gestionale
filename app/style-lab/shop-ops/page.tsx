    ...
    <main className="shop-ops-preview-shell" aria-label="Preview estetica shop operations">
      <section className="shop-ops-preview-hero">
        <div className="shop-ops-preview-brand">
          <Image alt="28 Print" priority sizes="72px" src={brandLogo} />
          <div>
            <span>Style lab</span>
        ...
        <div className="shop-ops-preview-hero-side">
          <div className="shop-ops-preview-hero-actions">
            ...
            <Link className="shop-ops-preview-button is-outline" href="/orders">
              Ordini ufficiali
            </Link>
          </div>
        </div>
      ...
      <section aria-label="Dashboard shop demo" className="shop-ops-preview-dashboard">
        ...
        <aside className="shop-ops-preview-panel shop-ops-preview-side">
          ...
          <p>Il colore forte serve per orientarsi, non per decorare. Lime significa: arrivato dallo shop e da prendere in mano.</p>
        </aside>
      </section>

      <section aria-label="Dettaglio ordine shop demo" className="shop-ops-preview-detail">
        <div className="shop-ops-preview-detail-head">
          ...
          <div className="shop-ops-preview-detail-actions">
            <button className="shop-ops-preview-button is-lime" type="button">
              Avvia lavorazione
            </button>
            <button className="shop-ops-preview-button is-outline" type="button">
              Segna pronto
            </button>
          </div>
        </div>
